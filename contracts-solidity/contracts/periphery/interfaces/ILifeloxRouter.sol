...
interface ILifeloxRouter {
    ...
    function addLiquidityPEX(
        ...
        address to,
        uint256 deadline
    ) external payable returns (uint256 amountToken, uint256 amountPEX, uint256 liquidity);
    ...
    function removeLiquidityPEX(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountToken, uint256 amountPEX);
    ...
    // ETH-named aliases (native = PEX) — the standard Uniswap-V2 names.
